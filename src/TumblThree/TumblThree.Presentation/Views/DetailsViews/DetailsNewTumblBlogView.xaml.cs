...
namespace TumblThree.Presentation.Views
{
    ...
    /// </summary>
    [Export("NewTumblBlogView", typeof(IDetailsView))]
    public partial class DetailsNewTumblBlogView : IDetailsView
    {
        private readonly Lazy<DetailsNewTumblBlogViewModel> viewModel;

        public DetailsNewTumblBlogView()
        {
            InitializeComponent();
            viewModel = new Lazy<DetailsNewTumblBlogViewModel>(() => ViewHelper.GetViewModel<DetailsNewTumblBlogViewModel>(this));
        }

        private DetailsNewTumblBlogViewModel ViewModel
        {
