...
#pragma warning disable SA1402 // File may only contain a single type
    ...
    public class Links
    {
        [DataMember(EmitDefaultValue = false)] public NsfwSurvey nsfw_survey { get; set; }
    }

    [DataContract]
    public class Reblog
    {
        [DataMember(EmitDefaultValue = false)] public string comment { get; set; }
    }
    ...
    public class Video
    {
        [DataMember(EmitDefaultValue = false)] public Youtube youtube { get; set; }
    }
