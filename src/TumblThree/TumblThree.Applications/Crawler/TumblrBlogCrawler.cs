...
namespace TumblThree.Applications.Crawler
{
    ...
    public class TumblrBlogCrawler : AbstractTumblrCrawler, ICrawler, IDisposable
    {
        ...
        public TumblrBlogCrawler(IShellService shellService, ICrawlerService crawlerService, IHttpRequestFactory webRequestFactory,
        ...
        {
            ulong.TryParse(response.Posts.FirstOrDefault().Id, out var highestPostId);
