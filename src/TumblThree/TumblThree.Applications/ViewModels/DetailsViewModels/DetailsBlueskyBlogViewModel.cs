...
namespace TumblThree.Applications.ViewModels.DetailsViewModels
{
    ...
    [ExportMetadata("BlogType", typeof(BlueskyBlog))]
    public class DetailsBlueskyBlogViewModel : ViewModel<IDetailsView>, IDetailsViewModel
    {
        ...
        public DetailsBlueskyBlogViewModel([Import("BlueskyBlogView", typeof(IDetailsView))] IDetailsView view, IClipboardService clipboardService, IDetailsService detailsService,
