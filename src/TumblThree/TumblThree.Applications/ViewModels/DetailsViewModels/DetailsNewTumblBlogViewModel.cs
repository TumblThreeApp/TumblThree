...
namespace TumblThree.Applications.ViewModels.DetailsViewModels
{
    ...
    [ExportMetadata("BlogType", typeof(NewTumblBlog))]
    public class DetailsNewTumblBlogViewModel : ViewModel<IDetailsView>, IDetailsViewModel
    {
        ...
        public DetailsNewTumblBlogViewModel([Import("NewTumblBlogView", typeof(IDetailsView))] IDetailsView view, IClipboardService clipboardService, IDetailsService detailsService,
