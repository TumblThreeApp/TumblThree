...
namespace TumblThree.Applications.ViewModels.DetailsViewModels
{
    ...
    public class DetailsTumblrLikesViewModel : ViewModel<IDetailsView>, IDetailsViewModel
    {
        ...
        public DetailsTumblrLikesViewModel([Import("TumblrLikesView", typeof(IDetailsView))] IDetailsView view, IClipboardService clipboardService, IDetailsService detailsService)
            : base(view)
        {
